...
from electrum_btcz.bitcoin import TYPE_ADDRESS
from electrum_btcz import WalletStorage, Wallet
from electrum_btcz_gui.kivy.i18n import _
from electrum_btcz.paymentrequest import InvoiceStore
from electrum_btcz.util import profiler, InvalidPassword
from electrum_btcz.plugins import run_hook
from electrum_btcz.util import format_satoshis, format_satoshis_plain
...
#Factory.register('InstallWizard', module='electrum_btcz_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_btcz_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_btcz_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_btcz_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_btcz_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_btcz_gui.kivy.uix.screens')
...
from electrum_btcz.util import base_units
...
class ElectrumWindow(App):
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'BTCZ')
    ...
    def on_qr(self, data):
        from electrum_btcz.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        if data.startswith('bitcoinz:'):
            self.set_URI(data)
            return
        # try to decode transaction
        from electrum_btcz.transaction import Transaction
        from electrum_btcz.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_btcz.util import format_time
    ...
    def on_start(self):
        ...
        # bind intent for bitcoinz: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def load_wallet_by_name(self, path):
        ...
        if wallet:
            ...
            Logger.debug('Electrum-BitcoinZ: Wallet not found. Launching install wizard')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_btcz_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_btcz_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_btcz_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_btcz_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-btcz.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-BitcoinZ', message,
