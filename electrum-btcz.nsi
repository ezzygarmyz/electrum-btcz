...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/electrum-btcz-${PRODUCT_VERSION}-setup-${BUILD_ARCH}.exe"
...
Section
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\electrum-btcz.ico"
