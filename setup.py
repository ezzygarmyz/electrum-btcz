...
setup(
    ...
    packages=[
        'electrum_btcz',
        'electrum_btcz_gui',
        'electrum_btcz_gui.qt',
        'electrum_btcz_plugins',
        'electrum_btcz_plugins.audio_modem',
        'electrum_btcz_plugins.cosigner_pool',
        'electrum_btcz_plugins.email_requests',
        'electrum_btcz_plugins.hw_wallet',
        'electrum_btcz_plugins.keepkey',
        'electrum_btcz_plugins.labels',
        'electrum_btcz_plugins.ledger',
        'electrum_btcz_plugins.trezor',
        'electrum_btcz_plugins.digitalbitbox',
        'electrum_btcz_plugins.virtualkeyboard',
    ],
    package_dir={
        'electrum_btcz': 'lib',
        'electrum_btcz_gui': 'gui',
        'electrum_btcz_plugins': 'plugins',
    },
    package_data={
        'electrum_btcz': [
            'servers.json',
